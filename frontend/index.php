                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a>Selling Service</a></h5>
                                <p>We'll help you sell your property quickly and for the best possible price.  Our marketing strategies and negotiation skills get results.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-for-rent text-primary flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a >Rental Service</a></h5>
                                <p>Finding the perfect rental is easy with Homex.  We assist both landlords and tenants in finding the right fit.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-list text-primary flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a >Property Listing</a></h5>
                                <p>Showcase your property to a wide audience.  Our comprehensive listing platform attracts qualified buyers and renters.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-primary flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a >Legal Investment</a></h5>
                                <p>Navigate the complexities of real estate investment with confidence. We provide expert guidance and connect you with legal professionals.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="living-list pr-4">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Trusted Real Estate Platform</h5>
										<p>We connect buyers, sellers, and renters with verified properties, ensuring a seamless and secure experience.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Best Market Deals</h5>
										<p>We provide real-time property listings at competitive prices, ensuring you get the best value for your investment.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Sell & Rent Hassle-Free</h5>
										<p>Easily list your property, connect with potential buyers/renters, and finalize deals without unnecessary delays.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Users consult with experts or communicate with buyers/sellers.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> Necessary documents (property ownership, agreements, etc.) are verified.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> Finalizing deals, making payments, and completing legal formalities.</p>
                        </div>
                    </div>
                </div>
            </div>
